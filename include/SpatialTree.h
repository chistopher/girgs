...
protected:
    ...
    void visitCellPair(unsigned int cellA, unsigned int cellB, unsigned int level, std::vector<Node>& graph);

    // sample edges of type 1 between V_i^A V_j^B
    void sampleTypeI(unsigned int cellA, unsigned int cellB, unsigned int level, unsigned int i, unsigned int j, std::vector<Node>& graph);
    // sample edges of type 2 between V_i^A V_j^B
    void sampleTypeII(unsigned int cellA, unsigned int cellB, unsigned int level, unsigned int i, unsigned int j, std::vector<Node>& graph);
